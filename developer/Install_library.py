...
def install_library_main():
    ...
    if choose == "1":
        ...
        print("开始一键安装第三方库")
        try:
            os.system("pip install pywifi requests validators urllib3 tqdm psutil ipaddress colorama pyinstaller cryptography Pillow comtypes pyfiglet")
        except Exception as e:
            print(f"安装失败{e}")
    elif choose == "3":
        print("开始检查所有库是否装好")
        try:
            ...
            print("开始检查 pyfiglet 库")
            print(f"{'='*80}")
            os.system("pip show pyfiglet")
            print("pyfiglet 库已装好")
            print(f"{'='*80}\n")
